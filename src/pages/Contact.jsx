  ...
  return (
    <div className='Contact'>
      ...
      <form action="" method='' ref={form} onSubmit={sendEmail}>
        <input type="text" placeholder='Name' name='from-name'  className='inn'/>
        <input type="email" placeholder='Email' name='Email' className='inn1' />
        <input type="text" placeholder='Subject' name='Subject' />
        <textarea  type="text" placeholder='Message' name='message' className='msg' />
      ...
      <div className="contact-right">
        ...
        <BsTelephone /> : 9069819600 
         ...
         <HiOutlineMail /> : saifali01X@gmail.com
          ...
          <div className="icon">
              <a href="https://github.com/saif-ali01"target={"blank"}><BsGithub /></a>
          </div>      
          <div className="icon">
            <a href="https://www.linkedin.com/in/saif-ali-285581243" target={"blank"}> <BsLinkedin /></a>
          </div>
          <div className="icon">
            <a href='https://instagram.com/0.1.saif?igshid=YmMyMTA2M2Y=' target={"blank"}><BsInstagram/></a>
          </div>
          </div>
        </div>
      </div>
